...
def main(speed=0, bg_color="gray"):
    ...
    colors_list = ["red", "purple", "brown", "pink", "green","cyan" , "yellow"]
    ...
    for i in range(10):
        ...
        color_code = random.randint(0, len(colors_list)-1)
        myTurtle.pencolor(colors_list[color_code])
